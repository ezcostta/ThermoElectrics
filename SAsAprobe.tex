...
We should obtain the same result if we substitute Eq. \eqref{delta:muS} into Eq. \eqref{JR} \footnote{Indee let's substitute Eq. \eqref{delta:muS} into Eq. \eqref{JR}:
\begin{align*}
J_{R}&= 
-\mathcal{L}_{RL,\mu}\delta\mu_{L} 
